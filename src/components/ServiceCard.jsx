...
const ServiceCard = ({ imgURL, label, subtext }) => {
  return (
    <div className="flex-1 sm:w-[350px] sm:min-w-[350px] w-full hover:scale-105 duration-300 ease-in-out rounded-[20px] shadow-3xl px-10 py-16 dark:bg-gray-800">
      <div className="w-11 h-11  flex justify-center items-center bg-coral-red rounded-full overflow-hidden object-contain">
        <img src={imgURL} alt={label} width={36} height={36} />
      </div>
